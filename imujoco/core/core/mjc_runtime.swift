...
public final class MJRuntime {
    ...
    public init(instanceIndex: Int32, targetFPS: Double = 60.0, busyWait: Bool = false, udpPort: UInt16 = 0, ctrlTimeoutMs: UInt32 = 500, sendForceData: Bool = false) throws {
        ...
        config.sendForceData = sendForceData
